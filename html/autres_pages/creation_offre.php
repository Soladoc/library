...
<body>
    ...
    <main>
        ...
        <section id="infos-detaillees">
            ...
            <fieldset>
                <p>Durée</p>
                <p><label>Début&nbsp;: <input id="start-time" type="time" required></label></p>
                <p><label>Fin&nbsp;: <input id="end-time" type="time" required></label></p>
                <input type="hidden" id="iso8601-interval" name="<?= $type_offre ?>[indication_duree]">
            </fieldset>
