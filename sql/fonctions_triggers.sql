...
declare
  ...
  boucle integer;
begin
  create view _offres as select * from pact._offre where id_professionnel=nb_offres_en_ligne.id_pro_cherche;
...
declare
  ...
  boucle integer;
begin
  create view _offres as select * from pact._offre where id_professionnel=nb_offres_hors_ligne.id_pro_cherche;
