...
begin
    ...
    insert into pact._compte(email, mdp_hash, nom, prenom, telephone, id_identite)
        values (new.email, new.mdp_hash, new.nom, new.prenom, new.telephone, id_temp);
    insert into pact._membre(pseudo, existe, email)
        values (new.pseudo, true, new.email);
    return new;
end;
$$
language 'plpgsql';
...
begin
    ...
    insert into pact._compte(email, mdp_hash, nom, prenom, telephone, id_identite)
        values (new.email, new.mdp_hash, new.nom, new.prenom, new.telephone, id_temp);
    insert into pact._professionnel(denomination, email, existe)
        values (new.denomination, new.email, true)
    returning
