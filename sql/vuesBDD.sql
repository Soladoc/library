...
create or replace view tous_comptes as select email,mdp_hash,existe,id_identite from _compte natural join _membre natural join _professionnel where existe= true;
