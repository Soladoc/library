...
from
    _professionnel
    join _public on id_professionnel = id_public
    natural join _compte;

create or replace view avis as
select
    *
from
    _avis;

create or replace view tous_comptes as
select
    email,
    mdp_hash,
    existe,
